...
namespace KeyDomain
{
    ...
    struct StateData : ITraitBasedStateData<TraitBasedObject, StateData>
    {
        ...
        public void AddObject(NativeArray<ComponentType> types, out TraitBasedObject traitBasedObject, TraitBasedObjectId traitBasedObjectId, FixedString64Bytes name = default)
        {
        ...
        public void AddObject(NativeArray<ComponentType> types, out TraitBasedObject traitBasedObject, out TraitBasedObjectId traitBasedObjectId, FixedString64Bytes name = default)
        {
        ...
        public void AddTraitBasedObject(ComponentType[] types, out TraitBasedObject traitBasedObject, out TraitBasedObjectId traitBasedObjectId, FixedString64Bytes name = default)
        {
            traitBasedObject = TraitBasedObject.Default;
            traitBasedObjectId = new TraitBasedObjectId() { Id = ObjectId.GetNext() };
#if DEBUG
        ...
        public void SetTraitOnObjectAtIndex<TTrait>(TTrait trait, int traitBasedObjectIndex) where TTrait : unmanaged, ITrait
        {
            var traitBasedObjectTraitIndex = TraitArrayIndex<TTrait>.Index;
            if (traitBasedObjectTraitIndex == -1)
                throw new ArgumentException($"Trait {typeof(TTrait)} not supported in this domain");
    ...
    [DisableAutoCreation]
    partial class StateManager : SystemBase, ITraitBasedStateManager<TraitBasedObject, StateEntityKey, StateData, StateDataContext>
    {
