...
namespace Unity.AI.Planner.Tests.Unit
{
    ...
    class SelectionJobTests
    {
        ...
        void SelectStates()
        {
            ...
            {
                m_DepthMap = new NativeParallelHashMap<int, int>(m_PlanGraph.Size, Allocator.TempJob);
...
namespace Unity.AI.Planner.Tests.Performance
{
    ...
    class SelectionJobPerformanceTests
    {
        ...
        public IEnumerator TestPerformanceOnLargeTree()
        {
            ...
            var depthMap = new NativeParallelHashMap<int, int>(nodeCount, Allocator.TempJob);
            ...
            PerformanceUtility.AssertRange(0.003, 0.15);
        }
