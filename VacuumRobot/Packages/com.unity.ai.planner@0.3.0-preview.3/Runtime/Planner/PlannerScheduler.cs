...
namespace Unity.AI.Planner
{
        ...
        where TDestroyStatesScheduler : struct, IDestroyStatesScheduler<TStateKey, TStateData, TStateDataContext, TStateManager>
    {
        ...
        public void SetTerminationEvaluator<TEvaluator>(TEvaluator evaluator) where TEvaluator : unmanaged, ITerminationEvaluator
        {
        ...
        public void SetCumulativeRewardEstimator<TEstimator>(TEstimator estimator) where TEstimator : unmanaged, ICumulativeRewardEstimator
        {
