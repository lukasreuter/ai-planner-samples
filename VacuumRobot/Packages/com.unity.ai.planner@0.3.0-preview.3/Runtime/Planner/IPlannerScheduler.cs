...
namespace Unity.AI.Planner
{
    ...
    public interface IPlannerScheduler : IDisposable
    {
        ...
        void SetTerminationEvaluator<TEvaluator>(TEvaluator evaluator) where TEvaluator : unmanaged, ITerminationEvaluator;
        ...
        void SetCumulativeRewardEstimator<TEstimator>(TEstimator estimator) where TEstimator : unmanaged, ICumulativeRewardEstimator;
