...
namespace Unity.AI.Planner.Traits
{
        ...
        where TObject : ITraitBasedObject
    {
        ...
        void AddObject(NativeArray<ComponentType> types, out TObject traitBasedObject, TraitBasedObjectId objectId,  FixedString64Bytes name = default);
        ...
        /// <param name="name">Name of the trait-based object</param>
        void AddObject(NativeArray<ComponentType> types, out TObject traitBasedObject, out TraitBasedObjectId objectId,  FixedString64Bytes name = default);
