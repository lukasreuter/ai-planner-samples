...
#pragma warning restore 0649
            ...
            foreach (var queryGroup in m_QueryGroups)
            {
                ...
                unsafe
                {
                    ...
                    else
                    {
                        ...
                        previousEntitiesValid.Copy(0, ref entitiesValid, 0, entitiesValid.Length);
                    }
                }
            }
        ...
        static void OrBits(UnsafeBitArray dst, UnsafeBitArray src)
        {
            ...
            {
                var previousBits = dst.IsSet(i);
                var newBits = src.IsSet(i);
                dst.Set(i, previousBits | newBits);
            }
        }
